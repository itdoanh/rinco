// Tests for notification-service platform.
package platform
...
func TestGetenv_Default(t *testing.T) {
	os.Unsetenv("NOTIF_TEST_VAR")
	if got := Getenv("NOTIF_TEST_VAR", "default"); got != "default" {
		t.Errorf("got %s, want default", got)
	}
}

func TestGetenv_Set(t *testing.T) {
	os.Setenv("NOTIF_TEST_VAR", "value")
	defer os.Unsetenv("NOTIF_TEST_VAR")
	if got := Getenv("NOTIF_TEST_VAR", "default"); got != "value" {
		t.Errorf("got %s, want value", got)
	}
}

func TestGetenv_EmptyEnv(t *testing.T) {
	os.Setenv("NOTIF_TEST_VAR", "")
	defer os.Unsetenv("NOTIF_TEST_VAR")
	if got := Getenv("NOTIF_TEST_VAR", "default"); got != "default" {
		t.Errorf("got %s, want default", got)
	}
...
func TestGetenvInt_Default(t *testing.T) {
	os.Unsetenv("NOTIF_TEST_INT")
	if got := GetenvInt("NOTIF_TEST_INT", 42); got != 42 {
		t.Errorf("got %d, want 42", got)
	}
}

func TestGetenvInt_Set(t *testing.T) {
	os.Setenv("NOTIF_TEST_INT", "100")
	defer os.Unsetenv("NOTIF_TEST_INT")
	if got := GetenvInt("NOTIF_TEST_INT", 42); got != 100 {
		t.Errorf("got %d, want 100", got)
	}
}

func TestGetenvInt_Invalid(t *testing.T) {
	os.Setenv("NOTIF_TEST_INT", "not-a-number")
	defer os.Unsetenv("NOTIF_TEST_INT")
	if got := GetenvInt("NOTIF_TEST_INT", 42); got != 42 {
...
func TestGetenvBool_Default(t *testing.T) {
	os.Unsetenv("NOTIF_TEST_BOOL")
	if !GetenvBool("NOTIF_TEST_BOOL", true) {
		t.Error("expected true default")
	}
}

func TestGetenvBool_True(t *testing.T) {
	os.Setenv("NOTIF_TEST_BOOL", "true")
	defer os.Unsetenv("NOTIF_TEST_BOOL")
	if !GetenvBool("NOTIF_TEST_BOOL", false) {
		t.Error("expected true")
	}
}

func TestGetenvBool_False(t *testing.T) {
	os.Setenv("NOTIF_TEST_BOOL", "false")
	defer os.Unsetenv("NOTIF_TEST_BOOL")
	if GetenvBool("NOTIF_TEST_BOOL", true) {
